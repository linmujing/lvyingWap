...
var instance = axios.create({
  ...
  baseURL: 'http://flgk.yohez.com/law-web-api/', // 测试环境2
  // baseURL: "/api/",                                      // 本地环境
...
//微信网页授权登录（公众号）
export const oaUserInfo = params => { return instance.post(`wechat/login/oa/customer/userInfo`, params ); };
...
// 获取会员信息
export const getCustomerInfo = params => { return instance.post(`customer/info/getCustomerInfo`, params ); };
